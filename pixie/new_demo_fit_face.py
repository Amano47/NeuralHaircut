...
def main(args):
    ...
    pixie.save_init_pixie(codedict, 'head', init_file_path)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--init_file_path', default='./initialization_pixie.pickle', type=str, help='Pixie Init Datei, eine gepicklelte Datei des param_dict')
